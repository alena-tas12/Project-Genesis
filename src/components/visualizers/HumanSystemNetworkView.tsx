...
import type { EpistemicCategory, EvidenceStatus } from '../../engine/core/ontology';
...
const networkNodes: NetworkNode[] = [
  // Cognitive
  { id: 'cog_perc', label: 'Perception (Observer)', domain: 'cognitive', icon: Eye, description: 'Observer/Architect Drive. Seeks awareness, meta-control, and structural understanding.', epistemicCategory: 'PERSONAL_OBSERVATION', validationState: 'UNKNOWN', confidence: 0.9 },
  ...
  { id: 'cog_learn', label: 'Pattern Unification', domain: 'cognitive', icon: BookOpen, description: 'Cognitive compression mechanisms. Recognizing templates.', epistemicCategory: 'PERSONAL_OBSERVATION', validationState: 'UNKNOWN', confidence: 0.95 },
  
  // Psychological
  { id: 'psy_ident', label: 'Identity Core (Trisha)', domain: 'psychological', icon: Anchor, description: 'Triadic Core: "She" (Trisha). The non-negotiable anchor.', epistemicCategory: 'PERSONAL_OBSERVATION', validationState: 'UNKNOWN', confidence: 0.99 },
  { id: 'psy_trust', label: 'Trust Core (Anwesha)', domain: 'psychological', icon: Heart, description: 'Triadic Core: "Her" (Anwesha). The stability channel.', epistemicCategory: 'PERSONAL_OBSERVATION', validationState: 'UNKNOWN', confidence: 0.95 },
  { id: 'psy_guard', label: 'Guardian Core (Princess)', domain: 'psychological', icon: Shield, description: 'Triadic Core: "Princess". Custodial, protective instinct.', epistemicCategory: 'PERSONAL_OBSERVATION', validationState: 'UNKNOWN', confidence: 0.95 },
  
  // Physiological
  { id: 'phys_sleep', label: 'Sleep & Recovery', domain: 'physiological', icon: Moon, description: 'Circadian rhythms and stamina regeneration.', epistemicCategory: 'EMPIRICAL', validationState: 'SUPPORTED', confidence: 0.9 },
  ...
  // Emotional
  { id: 'emo_state', label: 'ALENA Baseline', domain: 'emotional', icon: Scale, description: 'The Integration Drive. A default operating state seeking quiet nervous systems.', epistemicCategory: 'PERSONAL_OBSERVATION', validationState: 'UNKNOWN', confidence: 0.9 },
  
  // Social
  { id: 'soc_rel', label: 'Environmental Calibrator', domain: 'social_relational', icon: Users, description: 'Meso-scale cue (e.g., Angeline). Functions as a contextual safety signal.', epistemicCategory: 'PERSONAL_OBSERVATION', validationState: 'UNKNOWN', confidence: 0.85 },
];
